...
public class AppointmentDAO extends DAO {
    ...
    public ArrayList<Appointment> searchAppointment(Appointment a) {
        ...
        String sql = "SELECT a.id, a.status, a.appointmentTime, a.user_id, a.client_id, " +
    ...
    public boolean saveAppointment(Appointment a) {
        ...
        try {
            ...
            if (isNew) {
                String sqlApp = "INSERT INTO tblAppointment(status, appointmentTime, user_id, client_id) VALUES(?, ?, ?, ?)";
                ...
                String sqlApp = "UPDATE tblAppointment SET status = ?, appointmentTime = ?, user_id = ?, client_id = ? WHERE id = ?";
